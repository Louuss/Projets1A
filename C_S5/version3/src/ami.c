...
int numero_joueur_ami(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: numero_joueur_ami()");
    }
...
void augmenter_gain(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: augmenter_gain()");
    }
...
int get_numero_cible(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: get_numero_cible()");
    }
...
int get_numero_maitre(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: get_numero_maitre()");
    }
...
carte recuperer_carte_ami(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: recuperer_carte_ami()");
    }
...
void augmenter_energie(ami a, int i) {
    if (a == NULL){
        echec("L'ami est NULL: augmenter_energie()");
    }
...
void diminuer_energie(ami a, int i) {
    if (a == NULL){
        echec("L'ami est NULL: diminuer_energie()");
    }
...
void diminuer_idee(ami a, int i) {
    if (a == NULL){
        echec("L'ami est NULL: diminuer_idee()");
    }
...
int get_idee_ami(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: get_idee_ami()");
    }
...
void diminuer_vie(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: diminuer_vie()");
    }
...
int get_vie_ami(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: get_vie_ami()");
    }
...
void augmenter_idee_ami(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: augmenter_idee_ami()");
    }
...
struct position get_pos_ami(ami a) {
    if (a == NULL){
        echec("L'ami est NULL: get_pos_ami()");
    }

    return a->position;
}

void set_numero_cible(ami a, int num){
    if (a == NULL){
        echec("L'ami est NULL: set_numero_cible()");
    } 
    
    a->numero_adversaire = num;
}