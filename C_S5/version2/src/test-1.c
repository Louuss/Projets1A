...
bool test_piocher() {
    ...
    creer_grille(10);
    joueur j = creer_joueur(1);
    set_idee(j, 100);

    joueur adv = creer_joueur(2);
...
bool test_est_joueur() {
    ...
    remplir_grille(get_position_x(j), get_position_y(j), get_numero(j));
...
int main(int argc, char* argv[]) {
    ...
    int numero_carte = 0;
        ...
        printf("\n"ANSI_BOLD"VERSION 2 : TEST L'AFFICHAGE DES MESSAGES D'ERREURS"ANSI_BOLD_OFF" \n");
