...
int choisir_carte(joueur j) {
    ...
    //Cette boucle for choisie une carte aleatoirement dans la main si cette derniere peut etre jouer alors la boucle est quitte
    //si la carte ne peut pas etre jouer alors nous prenons la carte d'a cote
